...
export const createUserApi = async (param: any) => {
  return await requestClient.post('/user', param);
};
...
export const updateUserApi = async (id: number, param: any) => {
  return await requestClient.put(`/user/${id}`, param);
};
 ...
 * @returns
 */
export const resetPasswordApi = async (id: string, param: any) => {
  return await requestClient.put(`/user/${id}`, param);
};
...
export const deleteUserApi = async (id: number) => {
  return await requestClient.delete(`/user/${id}`);
};
